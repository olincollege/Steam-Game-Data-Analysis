...
def top_ten_most_negatively_reviewed(game_name, percent_positive, peak_players):
    ...
    index_of_highest_negative = sorted(range(len(percent_negative)), key=lambda i: percent_negative[i])[-10:]
...
def top_ten_most_negative_negative_reviews(game_name, number_of_negative_reviews, peak_players):
    index_of_top_reviewed = sorted(range(len(number_of_negative_reviews)), key=lambda i: number_of_negative_reviews[i])[-10:]
